...
# apiVersion: v1
# kind: Config
# current-context: ${cluster_config_context}
# contexts: [{name: ${cluster_config_context}, context: {cluster: ${cluster_config_context}, user: ${cluster_config_context}}}]
# users: [{name: ${cluster_config_context}, user: {auth-provider: {name: gcp}}}]
# clusters:
# - name: ${cluster_config_context}
#   cluster:
