...
Create the name of the service account to use
*/}}
{{- define "external-secrets.stores.kubernetes.serviceAccountName" -}}
{{- if .Values.stores.kubernetes.serviceAccount.create }}
{{- default (include "external-secrets.fullname" .) .Values.stores.kubernetes.serviceAccount.name }}
{{- else }}
{{- default "default" .Values.stores.kubernetes.serviceAccount.name }}
{{- end }}
{{- end }}
