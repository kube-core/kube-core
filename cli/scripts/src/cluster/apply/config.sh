...
## Header End
## Docs Start ##
## Applies cluster local config: localConfig_path
## Docs End ##

log_info "Applying local config..."

configPath=${localConfig_path}
apply_config "${configPath}"

log_info "Done Applying local config!"
