...
kubectl create ${kubectlArgs} ns configmaps || true # TODO: More GitOps friendly
...
mkdir -p ${configmaps_path}

localConfigmapsPath=${configmaps_path}/output
localReplicatedConfigmapsPath=${configmaps_path}/replicated

apply_config "${localConfigmapsPath}"
apply_config "${localReplicatedConfigmapsPath}"

log_info "Done Applying local Configmaps!"
