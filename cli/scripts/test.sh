...
${scripts_test_lint_path} "false"
${scripts_test_validate_path} "false"
${scripts_test_audit_path} "false"
${scripts_test_score_path} "false"
${scripts_test_conftest_path} "false"

log_info "Done Running all tests..."
